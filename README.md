...
Drone integrity, equipped perks, and carried shop supplies also remain per-player.
...
- **Run Settings:** Up/Down moves within a panel; Left/Right crosses between panels; Enter/Space cycles the focused value, toggles it, or confirms it; Begin Run starts loading
